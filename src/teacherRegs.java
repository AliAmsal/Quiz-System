 ...
 * @author Dell
 */
public class teacherRegs extends javax.swing.JFrame {

    /**
     * Creates new form teacherRegs
     */
    public teacherRegs() throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Teachers Registrations");
    ...
    private void approveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveButtonActionPerformed
        RandomAccessFile teacherFile;
        try {
            teacherFile = new RandomAccessFile("teacher.dat","rw");
            Teacher t = new Teacher();
            int n = (int) (teacherFile.length()/t.size());
            int dialogresult = JOptionPane.showConfirmDialog(null, "Do you want to approve this teacher's registration?","Warning",JOptionPane.YES_NO_OPTION);
            if(dialogresult == JOptionPane.YES_NO_OPTION) {
            
            for(int i = 0; i < n; i++) {
                t.read();
                if(t.getId() == Integer.parseInt(idTF.getText()) ) {
                    t.setRegStatus(Integer.parseInt(idTF.getText()),true);                    
                    tableUpdate();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            Teacher t = new Teacher();
            int dialogresult = JOptionPane.showConfirmDialog(null, "Do you want to delete this teacher's registration?","Warning",JOptionPane.YES_NO_OPTION);
            if(dialogresult == JOptionPane.YES_NO_OPTION) {
    ...
    private void pendingTableMouseClicked(java.awt.event.MouseEvent evt) throws FileNotFoundException, IOException {  
        ...
        for(int i = 0; i < n; i++) {
                t.read();
                if(t.getId() == Integer.parseInt((String) dft.getValueAt(index, 3).toString()) ){
